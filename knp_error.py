...
AT_2 = {1.95,1.00,1.95,1.00,1.95,1.00,1.95,1.00}
...
result_new['gab'] = result_new['posisi'].apply(lambda x:  '0.95,0.00,0.95,0.00,0.95,0.00,0.95,0.00' if x=='BW_1' else
                                                ...
                                                '1.95,1.00,1.95,1.00,1.95,1.00,1.95,1.00'  if x =='BW_2' else 
                                                '1.95,1.00,1.95,1.00,1.95,1.00,1.95,1.00'  if x =='AT_2' else 
                                                '2.95,2.00,2.95,2.00,2.95,2.00,2.95,2.00' if x =='BW_3' else 
                                                '2.95,2.00,2.95,2.00,2.95,2.00,2.95,2.00' if x =='AT_3' else 
                                                '3.95,3.00,3.95,3.00,3.95,3.00,3.95,3.00' if x =='BW_4' else
                                                '3.95,3.00,3.95,3.00,3.95,3.00,3.95,3.00' if x =='AT_4' else
                                                '4.95,4.00,4.95,4.00,4.95,4.00,4.95,4.00' if x =='BW_5' else
                                                '4.95,4.00,4.95,4.00,4.95,4.00,4.95,4.00' if x =='AT_5' else

                                                '6.95,6.00,6.95,6.00,6.95,6.00,6.95,6.00'
