...
v_gab=storage[['No_Batch','No_Batch','No_Batch','No_Batch','No_Batch','No_Batch','No_Batch','No_Batch']].astype(str).values.tolist()
...
while i < len(x_gab):
    fig_test.add_trace(go.Isosurface(
        ...
        hovertext=hvr_txt[i],
        hoverinfo='all',
        hovertemplate="Batch: %{value}, Produk: %{hovertext} <extra></extra>"
